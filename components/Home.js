...
export default ({ navigation, uid, nextVisit, selectUser, locations, currentDiseases, userLetters, letters, newVisit, editVisit, removeVisit, openDisease, removeDisease }) => selectUser.size === 0
